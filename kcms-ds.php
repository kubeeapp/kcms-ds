<?php
/*
Plugin Name:  KCMS Dev Switch
Plugin URI:   https://github.com/kubeeapp/kcms-ds/
Description:  Allows you to switch between different environments from the admin bar.
Version:      2.1.0
Author:       Kubee
...
namespace Kubeeapp\StageSwitcher;
